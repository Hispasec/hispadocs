...
AUTHOR = 'Nekmo'
EMAIL = 'joyague@hispasec.com'

# Información del paquete
PACKAGE_NAME = 'hispadocs'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Hispasec/hispadocs/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Hispasec/hispadocs'
STATUS_LEVEL = 3  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['odt', 'docs', 'join', 'merge', 'template']  # Palabras clave
